...
/* Copy this code snippet into your AndroidManifest.xml inside the <application> element:
    ...
    <provider
        android:name="com.example.lz.android_greendao_sample.SimpleEntityContentProvider"
        android:authorities="com.example.lz.android_greendao_sample.provider" />
*/

public class SimpleEntityContentProvider extends ContentProvider {

    public static final String AUTHORITY = "com.example.lz.android_greendao_sample.provider";
